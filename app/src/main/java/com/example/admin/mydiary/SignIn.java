...
import com.example.admin.mydiary.models.modelUser;
...
public class SignIn extends AppCompatActivity {
    EditText name, num, email, password,gender, dob;
    Button signin, gallery;
    FirebaseAuth firebaseAuth;
    ImageView imageView;
    DatabaseReference databaseReference;
    String mEmail, mPasword, mName, mNum, mImage, mGender, mDoB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dob = (EditText) findViewById(R.id.userBdate);
                ...
                firebaseAuth.createUserWithEmailAndPassword(mEmail, mPasword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            final modelUser user = new modelUser(mName, mNum, mEmail, mPasword, mImage,mGender,firebaseUser.getUid(),mDoB);
